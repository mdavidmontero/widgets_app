...
class _SideMenuState extends State<SideMenu> {
  ...
  Widget build(BuildContext context) {
    ...
    return NavigationDrawer(
      ...
      children:  [
        Padding(padding: EdgeInsets.fromLTRB(28, hasNotch ? 0 : 20, 16, 10), child: const Text('Main')),
        ...appMenuItems
          .sublist(0,3)
        .map(
        ...
        const Padding(padding: EdgeInsets.fromLTRB(28, 16,28,10),child: Text("More options")),
          ...appMenuItems
          .sublist(3,6)
        .map(
          (item) => NavigationDrawerDestination(
